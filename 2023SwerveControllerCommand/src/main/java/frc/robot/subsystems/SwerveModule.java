...
public class SwerveModule {
  ...
  private final FlywheelSim m_turnMotorSim = new FlywheelSim(
          ...
          ModuleConstants.kTurnMotorGearbox,
  ...
  public void simulationPeriodic(double dt) {
    ...
    System.out.printf("D Pos: %f\tD Vel: %f\tT Pos: %f\tT Vel: %f\n", m_driveEncoder.getDistance(), m_driveEncoder.getRate(), m_turningEncoder.getDistance(), m_turningEncoder.getRate());
  }
}
